    ...
    const kvs::Indent& indent ) const
{
    ...
    os << indent << bracket_l;
    {
        std::string format0 = m_data[0].format( delim, bracket_l, bracket_r );
        std::string format1 = m_data[1].format( delim, bracket_l, bracket_r );
        std::string format2 = m_data[2].format( delim, bracket_l, bracket_r );
